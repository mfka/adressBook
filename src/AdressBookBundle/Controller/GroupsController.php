...
use AdressBookBundle\Entity\Groups;
use AdressBookBundle\Form\GroupsType;
...
class GroupsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdressBookBundle:Groups')->findAll();
     ...
     * @Method("POST")
     * @Template("AdressBookBundle:Groups:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdressBookBundle:Groups')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdressBookBundle:Groups:edit.html.twig")
     */
